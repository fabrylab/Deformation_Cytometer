...
write_clickpoints_masks = True
write_clickpoints_markers = True
copy_images = False
...
if __name__ == "__main__":
    ...
    pipeline.add(ResultCombiner(data_storage, output="_evaluated_new_hand2.csv", output_config="_evaluated_config_new_hand2.txt"))
