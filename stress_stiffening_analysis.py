...
#%%remove bias
#p1
index = np.abs(angle_p1)>45#(R*Angle>0) & (R > 50) 
...
#p2
index = np.abs(angle_p2)>45#(R*Angle>0) & (R > 50) 
...
#p3
index = np.abs(angle_p3)>45#(R*Angle>0) & (R > 50) 
...
ax2.plot(stress_p1,strain_p1,'o')
ax2.plot(stress_p2,strain_p2,'o')
ax2.plot(stress_p3,strain_p3,'o')
