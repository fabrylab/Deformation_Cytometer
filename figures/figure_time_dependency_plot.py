...
plt.figure(1).axes[0].set_position([0.082778, 0.202909, 0.381927, 0.689799])
...
plt.figure(1).axes[1].set_position([0.555425, 0.202909, 0.386609, 0.710959])
plt.figure(1).axes[1].set_xlim(0.0, 67.0)
#plt.figure(1).axes[1].set_ylim(0.0, 150.0)
plt.figure(1).axes[1].spines['right'].set_visible(False)
plt.figure(1).axes[1].spines['top'].set_visible(False)
plt.figure(1).axes[1].get_legend()._set_loc((0.440211, 0.043432))
plt.figure(1).axes[1].text(0.5, 0.5, 'New Text', transform=plt.figure(1).axes[1].transAxes)  # id=plt.figure(1).axes[2].texts[0].new
plt.figure(1).axes[1].texts[0].set_position([-0.203916, 1.007277])
