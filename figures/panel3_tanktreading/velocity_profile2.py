...
plt.figure(1).set_size_inches(16.250000/2.54, 12.490000/2.54, forward=True)
...
plt.figure(1).axes[0].set_position([0.064770, 0.760389, 0.246095, 0.230404])
...
plt.figure(1).axes[0].texts[0].set_position([-0.144428, 0.914934])
...
plt.figure(1).axes[0].texts[1].set_position([0.935586, 0.914934])
...
plt.figure(1).axes[1].set_yticklabels(["0.0k", "0.5k", "1.0k"], fontsize=10)
plt.figure(1).axes[1].set_position([0.404050, 0.760389, 0.246095, 0.230404])
...
plt.figure(1).axes[2].set_position([0.731926, 0.760493, 0.246095, 0.230404])
...
plt.figure(1).axes[2].texts[0].set_position([-0.296585, 0.914934])
...
plt.figure(1).axes[3].set_xticklabels(["0.01", "0.1", "1", "10", "100", "1000"], fontsize=10.0, fontweight="normal", color="black", fontstyle="normal", fontname="Arial", horizontalalignment="center")
plt.figure(1).axes[3].set_yticklabels(["0.3", "1.0", "3.0"], fontsize=10.0, fontweight="normal", color="black", fontstyle="normal", fontname="Arial", horizontalalignment="right")
plt.figure(1).axes[3].set_position([0.743330, 0.411794, 0.229335, 0.227322])
...
plt.figure(1).axes[4].set_position([0.048858, 0.411794, 0.262007, 0.227322])
...
plt.figure(1).axes[5].set_position([0.404050, 0.408138, 0.246095, 0.245674])
...
plt.figure(1).axes[5].texts[0].set_position([-0.261610, 0.914316])
plt.figure(1).axes[5].texts[0].set_text("f")
plt.figure(1).axes[5].texts[0].set_weight("bold")
plt.figure(1).axes[6].legend(ncol=2, title="pressure (bar)", fontsize=10.0, title_fontsize=10.0)
plt.figure(1).axes[6].set_position([0.170477, 0.100614, 0.479668, 0.230404])
plt.figure(1).axes[6].spines['right'].set_visible(False)
plt.figure(1).axes[6].spines['top'].set_visible(False)
plt.figure(1).axes[6].get_legend()._set_loc((1.139701, -0.385349))
plt.figure(1).axes[6].get_legend()._set_loc((1.133176, 0.038948))
plt.figure(1).axes[6].text(0.5, 0.5, 'New Text', transform=plt.figure(1).axes[6].transAxes)  # id=plt.figure(1).axes[6].texts[0].new
plt.figure(1).axes[6].texts[0].set_position([-0.219584, 1.023109])
