...
if 0:
    ...
    for path in alg25:
        with open(Path(path) / "meta.yaml", "w") as fp:
            fp.write(f"measurement_id: {Path(path).name}\nalginate: 2.5%")
    ...
    alg15 = [
        ...
        r"\\131.188.117.96\biophysDS\emirzahossein\microfluidic cell rhemeter data\evaluation\diff % alginate\2020_10_14_alginate1.5%_dmem_NIH_3T3",
         r"\\131.188.117.96\biophysDS\emirzahossein\microfluidic cell rhemeter data\evaluation\diff % alginate\2020_10_14_alginate1.5%_dmem_NIH_3T3_2",
    ...
    for index, time in enumerate(range(1, 13, 1)):
        f = []
        ...
        for path in [
            ...
            with open(Path(path).parent / "meta.yaml", "w") as fp:
                fp.write(f"time: {time*5}min")
    ...
    for index, pos in enumerate(["inlet", "middle", "outlet"]):
        ...
        # iterate over the different experiment paths
        for path in [
            fr"\\131.188.117.96\biophysDS\emirzahossein\microfluidic cell rhemeter data\microscope_1\august_2020\2020_08_14_alginate2%_diffxposition_2\{pos}",
            fr"\\131.188.117.96\biophysDS\emirzahossein\microfluidic cell rhemeter data\microscope_1\august_2020\2020_08_21_alginate2%_NIH_xposition_1\{pos}",
            fr"\\131.188.117.96\biophysDS\emirzahossein\microfluidic cell rhemeter data\microscope_1\august_2020\2020_08_21_alginate2%_NIH_xposition_2\{pos}",
            fr"\\131.188.117.96\biophysDS\emirzahossein\microfluidic cell rhemeter data\microscope_1\august_2020\2020_08_21_alginate2%_NIH_xposition_3\{pos}",
            fr"\\131.188.117.96\biophysDS\emirzahossein\microfluidic cell rhemeter data\microscope4\2020_july\2020_07_29_alginate2%_NIH_diff_x_position_2\{pos}",
            fr"\\131.188.117.96\biophysDS\emirzahossein\microfluidic cell rhemeter data\microscope4\2020_july\2020_07_29_alginate2%_NIH_diff_x_position_3\{pos}",

        ]:
            with open(Path(path) / "meta.yaml", "w") as fp:
                fp.write(f"pos: {pos}\n")
            print(Path(path).parent / "meta.yaml")
            with open(Path(path).parent / "meta.yaml", "w") as fp:
                fp.write(f"measurement_id: {Path(path).parent.name}\nalginate: 2.0%\n")
    ...
    for path in [
        ...
        #rf"\\131.188.117.96\biophysDS\emirzahossein\microfluidic cell rhemeter data\microscope4\2020_may\2020_05_22_alginateDMEM2%\{time}\*_result.txt",
        rf"\\131.188.117.96\biophysDS\emirzahossein\microfluidic cell rhemeter data\microscope4\2020_july\2020_07_21_alginate2%_dmem_NIH_time_1",
...
def plot_pair(data, parameter):
    ...
    plotMeasurementOfParameter(data, parameter, "k_cell", "C0")
    plt.axes([0.5, .2, 0.5, 0.5], label=f"{parameter}_k")
    plotMeasurementOfParameter(data, parameter, "alpha_cell", "C1")
...
plt.figure(1).ax_dict["alginate_alpha"].set_ylim(0.0, 261.74081154926006)
plt.figure(1).ax_dict["alginate_alpha"].set_yticks([0.0, 200.0])
...
plt.figure(1).ax_dict["alginate_k"].set_ylim(0.0, 0.5)
plt.figure(1).ax_dict["alginate_k"].set_yticklabels([])
...
plt.figure(1).ax_dict["cell_size_alpha"].set_ylim(0.0, 261.74081154926006)
plt.figure(1).ax_dict["cell_size_alpha"].set_xticks([0.0, 1.0, 2.0])
plt.figure(1).ax_dict["cell_size_alpha"].set_yticks([0.0, 200.0])
...
plt.figure(1).ax_dict["cell_size_k"].set_ylim(0.0, 0.5)
plt.figure(1).ax_dict["cell_size_k"].set_xticks([0.0, 1.0, 2.0])
plt.figure(1).ax_dict["cell_size_k"].set_yticks([0.0, 0.25, 0.5])
